...
export type EntidadesSyncMap = {
    ...
    regiao: EntidadeSyncConfig<Prisma.RegiaoDelegate<any>, Prisma.RegiaoSelect& BaseSelect>; // Assuming Regiao model exists
    fonteVariavel: EntidadeSyncConfig<Prisma.FonteVariavelDelegate<any>, Prisma.FonteVariavelSelect& BaseSelect>;
    variavelCategorica: EntidadeSyncConfig<Prisma.VariavelCategoricaDelegate<any>, Prisma.VariavelCategoricaSelect& BaseSelect>;
    tema: EntidadeSyncConfig<Prisma.TemaDelegate<any>, Prisma.TemaSelect& BaseSelect>;
    ods: EntidadeSyncConfig<Prisma.OdsDelegate<any>, Prisma.OdsSelect& BaseSelect>; // Assuming Ods model exists
