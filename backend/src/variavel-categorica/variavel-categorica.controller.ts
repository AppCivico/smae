...
import { ROLES_ACESSO_VARIAVEL_PDM, ROLES_ACESSO_VARIAVEL_PS } from '../variavel/variavel.controller';
...
export class VariavelCategoricaController {
    ...
    @Get('')
    @ApiBearerAuth('access-token')
    @Roles(['CadastroVariavelCategorica.administrador', ...ROLES_ACESSO_VARIAVEL_PDM, ...ROLES_ACESSO_VARIAVEL_PS])
    async listAll(
