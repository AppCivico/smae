...
export class GrupoTematicoService {
    ...
    async create(projetoId: number, dto: CreateGrupoTematicoDto, user: PessoaFromJwt): Promise<RecordWithId> {
    ...
    async findAll(projetoId: number, user: PessoaFromJwt): Promise<GrupoTematico[]> {
    ...
    async findOne(projetoId: number, id: number, user: PessoaFromJwt): Promise<GrupoTematico> {
