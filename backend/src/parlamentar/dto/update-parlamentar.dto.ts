...
export class UpdateRepresentatividadeDto extends PartialType(OmitType(CreateMandatoRepresentatividadeDto, ['mandato_id', 'municipio_tipo', 'nivel', 'regiao_id', 'numero_comparecimento'])) { }