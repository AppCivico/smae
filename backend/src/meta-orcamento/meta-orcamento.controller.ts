...
import { CreateMetaOrcamentoDto, FilterMetaOrcamentoDto, ListMetaOrcamentoDto } from './dto/meta-orcamento.dto';
...
export class MetaOrcamentoController {
    ...
    async upsert(@Body() createMetaDto: CreateMetaOrcamentoDto, @CurrentUser() user: PessoaFromJwt): Promise<RecordWithId> {
        return await this.metaOrcamentoService.upsert(createMetaDto, user);
    }
