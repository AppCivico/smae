...
export class DotacaoProcessoService {
    ...
    async valorRealizadoProcesso(dto: AnoDotacaoProcessoDto): Promise<ValorRealizadoProcessoDto[]> {
        ...
        return await this.sincronizarDotacaoRealizado(dto, mesMaisAtual);
    }



    private async sincronizarDotacaoRealizado(dto: AnoDotacaoProcessoDto, mes: number): Promise<ValorRealizadoProcessoDto[]> {
