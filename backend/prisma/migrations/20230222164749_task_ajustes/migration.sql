/*
  ...
  - You are about to drop the `tarefa_predecessora` table. If the table is not empty, all the data it contains will be lost.

*/
-- CreateEnum
CREATE TYPE "TarefaDependenteTipo" AS ENUM ('termina_pro_inicio', 'inicia_pro_inicio', 'inicia_pro_termino', 'termina_pro_termino');
...
-- DropForeignKey
ALTER TABLE "tarefa_predecessora" DROP CONSTRAINT "tarefa_predecessora_tarefa_id_fkey";

-- DropForeignKey
ALTER TABLE "tarefa_predecessora" DROP CONSTRAINT "tarefa_predecessora_tarefa_predecessora_id_fkey";

-- AlterTable
ALTER TABLE "projeto" ADD COLUMN     "tarefa_lock_seq" INTEGER NOT NULL DEFAULT 0;

-- DropTable
DROP TABLE "Tarefa";

-- DropTable
DROP TABLE "tarefa_predecessora";
...
CREATE TABLE "tarefa" (
    ...
    "inicio_planejado_calculado" BOOLEAN NOT NULL DEFAULT false,
    "termino_planejado_calculado" BOOLEAN NOT NULL DEFAULT false,
    "duracao_planejado_calculado" BOOLEAN NOT NULL DEFAULT false,
    "inicio_real_calculado" BOOLEAN NOT NULL DEFAULT false,
    "termino_real_calculado" BOOLEAN NOT NULL DEFAULT false,
    "duracao_real_calculado" BOOLEAN NOT NULL DEFAULT false,
    "n_filhos_imediatos" INTEGER NOT NULL DEFAULT 0,
...
-- CreateTable
CREATE TABLE "tarefa_dependente" (
    "id" SERIAL NOT NULL,
    "tarefa_id" INTEGER NOT NULL,
    "dependencia_tarefa_id" INTEGER NOT NULL,
    "tipo" "TarefaDependenteTipo" NOT NULL,
    "latencia" INTEGER NOT NULL,

    CONSTRAINT "tarefa_dependente_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "tarefa_dependente" ADD CONSTRAINT "tarefa_dependente_tarefa_id_fkey" FOREIGN KEY ("tarefa_id") REFERENCES "tarefa"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tarefa_dependente" ADD CONSTRAINT "tarefa_dependente_dependencia_tarefa_id_fkey" FOREIGN KEY ("dependencia_tarefa_id") REFERENCES "tarefa"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
