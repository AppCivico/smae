-- AlterTable
ALTER TABLE "tarefa" ADD COLUMN     "n_dep_inicio_planejado" SMALLINT NOT NULL DEFAULT 0,
ADD COLUMN     "n_dep_termino_planejado" SMALLINT NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE INDEX "tarefa_tarefa_pai_id_idx" ON "tarefa"("tarefa_pai_id");

-- CreateIndex
CREATE INDEX "tarefa_projeto_id_removido_em_idx" ON "tarefa"("projeto_id", "removido_em");

-- CreateIndex
CREATE INDEX "tarefa_tarefa_pai_id_removido_em_idx" ON "tarefa"("tarefa_pai_id", "removido_em");
