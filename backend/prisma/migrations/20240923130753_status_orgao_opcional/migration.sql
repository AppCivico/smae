...
update task_queue set status ='pending' where erro_mensagem like '%ultimo_periodo_valido("Periodicidade", integer) does not exist%' or erro_mensagem like '%Error: executeJob failed: Error: executeJob failed: PrismaClientKnownRequestError:%';
