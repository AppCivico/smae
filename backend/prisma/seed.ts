...
const ModuloDescricao: Record<string, [string, ModuloSistema | null]> = {
    ...
    CadastroOds: ['Cadastro de Categorias', 'PDM'],
    ...
    CadastroTag: ['Cadastro de Tag', 'PDM'],
    CadastroMacroTema: ['Cadastro de Macro Tema', 'PDM'],
    CadastroSubTema: ['Cadastro de Sub Tema', 'PDM'],
    CadastroTema: ['Cadastro de Tema', 'PDM'],
