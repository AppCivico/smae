...
<template>
  ...
  <div class="mb4 disparo-email">
    <div class="">
      <Form :validation-schema="schema" @submit="onSubmit">
        <div class="mb2">
          <LabelFromYup name="disparo_email" :schema="schema" />
          <Field
            name="disparo_email"
            type="checkbox"
            value="true"
  ...
  <table v-if="árvoreDeTarefas.length" class="tabela-de-etapas">
    <colgroup>
    ...
    <thead>
      <tr class="pl3 center mb05 tc300 w700 t12 uc">
        ...
        <th />
        <th />
        <th colspan="2" class="dado-estimado">Planejado</th>
        <th colspan="2" class="dado-efetivo">Execução</th>
        <th colspan="2">Custo <small>(R$)</small></th>
        <th />
        <template v-if="!apenasLeitura">
          <th />
          <th />
      ...
      <tr class="pl3 center mb05 tc300 w700 t12 uc">
        <th />
        <th />
        <th class="cell--number">% conclusão</th>
        <th class="cell--number">Duração</th>
        <th class="cell--data">Início</th>
        <th class="cell--data">Término</th>
        <th class="cell--data">Início</th>
        <th class="cell--data">Término</th>
        <th class="cell--number dado-estimado">Planejado</th>
        <th class="cell--number dado-efetivo">Real</th>
        <th class="cell--number">Atraso</th>
        <template v-if="!apenasLeitura">
          <th />
          <th />
          <th />
  ...
  <span v-if="chamadasPendentes?.lista" class="spinner">Carregando</span>
