...
import { useAuthStore, useIniciativasStore, useAtividadesStore } from '@/stores';
        ...
        <div class="boards">
            <template v-if="singleIniciativa.id">
                ...
                <div class="flex spacebetween center mt4 mb2">
                    <h2 class="mb0">Atividades</h2>
                    <hr class="ml2 f1"/>
                    <router-link v-if="perm?.CadastroAtividade?.inserir" :to="`${parentlink}/atividades/novo`" class="btn ml2">Adicionar atividade</router-link>
                </div>
                ...
                <div v-if="!Atividades[iniciativa_id].length" class="board_vazio">
                    <div class="tc">
                        ...
                        <router-link v-if="perm?.CadastroAtividade?.inserir" :to="`${parentlink}/atividades/novo`" class="btn mt1 mb1"><span>Adicionar atividade</span></router-link>
                    </div>
                </div>
