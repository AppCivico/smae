            ...
            <template v-if="tempIndicadores.length">
                <template v-for="ind in tempIndicadores" :key="ind.id">
                    ...
                    <template v-if="!Variaveis[ind.id]?.loading">
                        <div class="board_variavel mb2" v-for="v in Variaveis[ind.id]" :key="v.id">
                            <header class="p1">
                                <div class="flex center g2">
                                    <div class="flex center f1">
                                    ...
                                    <div class="f0 dropbtn right" v-if="perm?.CadastroIndicador?.editar">
                                        ...
                                        <ul>
                                            <li><router-link :to="`${parentlink}/evolucao/${ind.id}/variaveis/${v.id}`" class="tprimary">Editar variável</router-link></li>
                                            <li><router-link :to="`${parentlink}/evolucao/${ind.id}/variaveis/${v.id}/valores`" class="tprimary">Valores previstos</router-link></li>
                                            <li><router-link v-if="perm.CadastroPessoa?.administrador" :to="`${parentlink}/evolucao/${ind.id}/variaveis/${v.id}/retroativos`" class="tprimary">Valores realizados retroativos</router-link></li>
                                        </ul>
                                    </div>
                                </div>
