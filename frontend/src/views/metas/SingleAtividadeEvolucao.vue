...
import { useAuthStore, useMetasStore, usePdMStore, useIniciativasStore, useAtividadesStore } from '@/stores';
...
function start(){
    ...
    (async()=>{
        ...
        if(!tempIndicadores.value.length||tempIndicadores.value[0].atividade_id != atividade_id) await IndicadoresStore.filterIndicadores(atividade_id,'atividade_id');
