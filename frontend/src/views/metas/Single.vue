                ...
                <div class="board_variavel" v-for="ini in Iniciativas[meta_id]">
                    <header class="p1">
                        <div class="flex center g2 mb1">
                            <div class="f0" style="flex-basis: 2rem;">
                            ...
                            <h2 class="f1 mt1 mb1">{{ini.titulo}}</h2>
                            <div class="f0">
                                <router-link :to="`/metas/${meta_id}/iniciativas/${ini.id}`" class="tprimary"><svg width="20" height="20"><use xlink:href="#i_edit"></use></svg></router-link>
                            </div>
                        </div>
                        <div class="f1 ml2">
