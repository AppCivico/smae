...
IndicadoresStore.filterIndicadores(id);
                ...
                <div v-if="tempIndicadores.length" v-for="ind in tempIndicadores" style="border: 1px solid #E3E5E8; border-top: 8px solid #F2890D;">
                    <div class="p1">
                        <div class="flex center g2">
                            ...
                            <div class="f0">
                                <router-link :to="`/metas/${id}/indicadores/${ind.id}`" class="ml1 tprimary"><svg width="20" height="20"><use xlink:href="#i_edit"></use></svg></router-link>
                            </div>
                        </div>
                    </div>
                </div>
