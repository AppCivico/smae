...
const dataMin = new Date(`${import.meta.env.VITE_DATA_MIN}`) || new Date('1900-01-01T00:00:00Z');
const dataMax = new Date(`${import.meta.env.VITE_DATA_MAX}`) || new Date('2100-12-31T23:59:59Z');
