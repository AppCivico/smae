...
<template>
    <nav v-if="user" id="menu" class="only-desktop-menu" :class="{aberto: menuMobile}">
        <div class="top">
            ...
            <router-link to="/" @click="toggleMenu" :class="{active: props.activate=='SubmenuConfig'}">
            ...
            <router-link to="/metas" @click="toggleMenu" :class="{active: props.activate=='SubmenuMetas'}">
                <span>Metas</span>
