  ...
  >
    <div class="top">
      ...
      <router-link
        to="/paineis"
        @click="toggleMenu"
        :class="{ active: props.activate == 'SubmenuPaineis' }"
      >
        <span>Paineis</span>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M20 2H4C3.46957 2 2.96086 2.21071 2.58578 2.58578C2.21071 2.96086 2 3.46957 2 4V20C2 20.5304 2.21071 21.0391 2.58578 21.4142C2.96086 21.7893 3.46957 22 4 22H20C20.5304 22 21.0391 21.7893 21.4142 21.4142C21.7893 21.0391 22 20.5304 22 20V4C22 3.46957 21.7893 2.96086 21.4142 2.58578C21.0391 2.21071 20.5304 2 20 2ZM20 4V8H19.6L18 9.59999L13.9 5.5L9.9 10.5L7 7.59999L4.6 10H4V4H20ZM4 20V12H5.4L7 10.4L10.1 13.5L14.1 8.5L18 12.4L20.5 10H20V20H4Z"/>
        <path d="M7 16H5V19H7V16Z"/>
        <path d="M11 15H9V19H11V15Z"/>
        <path d="M15 13H13V19H15V13Z"/>
        <path d="M19 15H17V19H19V15Z"/>
        </svg>
      </router-link>
