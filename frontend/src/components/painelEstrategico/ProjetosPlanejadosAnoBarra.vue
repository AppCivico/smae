<template>
  <div
    class="ProjetosPlanejadosAnoMain"
    onload="init();"
  >
    <div id="ProjetosPlanejadosAnoContainer">
      <ul
        id="ProjetosPlanejadosAnoCol1"
        style="margin-right: 3px; min-width: fit-content;"
      >
        <li style="text-align: center; margin-bottom: -10px; min-width: fit-content;">
          <p
            id="ProjetosPlanejadosAnoLabel1"
            style="min-width: fit-content;"
          />
        </li>
        <li
          id="ProjetosPlanejadosAnoBarra1"
          class="ProjetosPlanejadosHorizontalBar"
        >
          <!-- TOOLTIP da primeira barra  -->
          <div
            id="ProjetosPlanejadosAnoBarra1Tooltip"
            class="ProjetosConcluidosTooltipTextLeft"
          >
            <div class="ProjetosPlanejadosAnoFirstLine">
              <hr class="ProjetosPlanejadosAnoFirstLineHR">
              <div
                id="ProjetosPlanejadosAnoBarra1Total"
                class="ProjetosPlanejadosAnoFirstLineMonthYear"
              >
                TOTAL DE
              </div>
            </div>
            <div class="ProjetosPlanejadosAnoSecondLine">
              <div
                id="ProjetosPlanejadosAnoBarra1Qtd"
                class="ProjetosPlanejadosAnoSecondLineQtd"
              />
              <div
                id="ProjetosPlanejadosAnoBarra1Desc"
                class="ProjetosPlanejadosAnoSecondLineDes"
                style="margin-top: -15px;"
              />
            </div>
            <div
              class="ProjetosPlanejadosAnoThirdLine"
      ...
      <ul
        id="ProjetosPlanejadosAnoCol2"
        style="margin-right: 3px; min-width: fit-content;"
      >
        <li style="text-align: center; margin-bottom: -10px; min-width: fit-content;">
          <p
            id="ProjetosPlanejadosAnoLabel2"
            style="min-width: fit-content;"
          />
        </li>
        <li
          id="ProjetosPlanejadosAnoBarra2"
          class="ProjetosPlanejadosHorizontalBar"
        >
          <!-- TOOLTIP da segunda barra -->
          <div
            id="ProjetosPlanejadosAnoBarra2Tooltip"
            class="ProjetosConcluidosTooltipTextLeft"
          >
            <div class="ProjetosPlanejadosAnoFirstLine">
              <hr class="ProjetosPlanejadosAnoFirstLineHR">
              <div
                id="ProjetosPlanejadosAnoBarra2Total"
                class="ProjetosPlanejadosAnoFirstLineMonthYear"
              >
                TOTAL DE
              </div>
            ...
            <div class="ProjetosPlanejadosAnoSecondLine">
              <div
                id="ProjetosPlanejadosAnoBarra2Qtd"
                class="ProjetosPlanejadosAnoSecondLineQtd"
              />
              <div
                id="ProjetosPlanejadosAnoBarra2Desc"
                class="ProjetosPlanejadosAnoSecondLineDes"
                style="margin-top: -15px;"
              />
            </div>
      ...
      <ul
        id="ProjetosPlanejadosAnoCol3"
        style="margin-right: 3px; min-width: fit-content;"
      >
        <li style="text-align: center; margin-bottom: -10px; min-width: fit-content;">
          <p
            id="ProjetosPlanejadosAnoLabel3"
            style="min-width: fit-content;"
          />
        </li>
        <li
          id="ProjetosPlanejadosAnoBarra3"
          class="ProjetosPlanejadosHorizontalBar"
        >
          <!-- TOOLTIP da terceira barra -->
          <div
            id="ProjetosPlanejadosAnoBarra3Tooltip"
            class="ProjetosConcluidosTooltipTextRight"
          >
            <div class="ProjetosPlanejadosAnoFirstLine">
              <hr class="ProjetosPlanejadosAnoFirstLineHR">
              <div
                id="ProjetosPlanejadosAnoBarra3Total"
                class="ProjetosPlanejadosAnoFirstLineMonthYear"
              >
                TOTAL DE
              </div>
            ...
            <div class="ProjetosPlanejadosAnoSecondLine">
              <div
                id="ProjetosPlanejadosAnoBarra3Qtd"
                class="ProjetosPlanejadosAnoSecondLineQtd"
              />
              <div
                id="ProjetosPlanejadosAnoBarra3Desc"
                class="ProjetosPlanejadosAnoSecondLineDes"
                style="margin-top: -15px;"
              />
            </div>
      ...
      <ul
        id="ProjetosPlanejadosAnoCol4"
        style="min-width: fit-content;"
      >
        <li style="text-align: center; margin-bottom: -10px; min-width: fit-content;">
          <p
            id="ProjetosPlanejadosAnoLabel4"
            style="min-width: fit-content;"
          />
        </li>
        <li
          id="ProjetosPlanejadosAnoBarra4"
          class="ProjetosPlanejadosHorizontalBar"
        >
          <!-- TOOLTIP da quarta barra -->
          <div
            id="ProjetosPlanejadosAnoBarra4Tooltip"
            class="ProjetosConcluidosTooltipTextRight"
          >
            <div class="ProjetosPlanejadosAnoFirstLine">
              <hr class="ProjetosPlanejadosAnoFirstLineHR">
              <div
                id="ProjetosPlanejadosAnoBarra4Total"
                class="ProjetosPlanejadosAnoFirstLineMonthYear"
              >
                TOTAL DE
              </div>
            ...
            <div class="ProjetosPlanejadosAnoSecondLine">
              <div
                id="ProjetosPlanejadosAnoBarra4Qtd"
                class="ProjetosPlanejadosAnoSecondLineQtd"
              />
              <div
                id="ProjetosPlanejadosAnoBarra4Desc"
                class="ProjetosPlanejadosAnoSecondLineDes"
                style="margin-top: -15px;"
              />
            </div>
...
const barsBackgroundColor = '#A77E11';
...
if (props.projetosPlanejadosAno != null && props.projetosPlanejadosAno.length > 0) {
  ...
  const dataSortedByYear = props.projetosPlanejadosAno.sort((a, b) => {
    if (a.ano < b.ano) {
      return -1;
    }
  });
  ...
  function init() {
    ...
    const singularExpression = 'PROJETO PLANEJADO';
    const pluralExpression = 'PROJETOS PLANEJADOS';
