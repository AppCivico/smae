<template>
  ...
  >
    <div id="ProjetosConcluidosAnoContainer">
        ...
        >
          ...
          >
            ...
            <div class="ProjetosConcluidosAnoSecondLine">
              <div
                id="ProjetosConcluidosAnoBarra1Qtd"
                class="ProjetosConcluidosAnoSecondLineQtd"
              />
              <div
                id="ProjetosConcluidosAnoBarra1Desc"
                class="ProjetosConcluidosAnoSecondLineDes"
                style="margin-top: -15px;"
              />
            </div>
            <div
              class="ProjetosConcluidosAnoThirdLine"
      ...
      <ul
        id="ProjetosConcluidosAnoCol2"
        style="margin-right: 3px; min-width: fit-content;"
      >
        <li style="text-align: center; margin-bottom: -10px; min-width: fit-content;">
          <p
            id="ProjetosConcluidosAnoLabel2"
            style="min-width: fit-content;"
          />
        </li>
        <li
          id="ProjetosConcluidosAnoBarra2"
          class="ProjetosConcluidosHorizontalBar"
        >
          <!-- TOOLTIP da segunda barra -->
          <div
            id="ProjetosConcluidosAnoBarra2Tooltip"
            class="ProjetosConcluidosTooltipTextLeft"
          >
            <div class="ProjetosConcluidosAnoFirstLine">
              <hr class="ProjetosConcluidosAnoFirstLineHR">
              <div
                id="ProjetosConcluidosAnoBarra2Total"
                class="ProjetosConcluidosAnoFirstLineMonthYear"
              >
                TOTAL DE
              </div>
            ...
            <div class="ProjetosConcluidosAnoSecondLine">
              <div
                id="ProjetosConcluidosAnoBarra2Qtd"
                class="ProjetosConcluidosAnoSecondLineQtd"
              />
              <div
                id="ProjetosConcluidosAnoBarra2Desc"
                class="ProjetosConcluidosAnoSecondLineDes"
                style="margin-top: -15px;"
              />
            </div>
      ...
      <ul
        id="ProjetosConcluidosAnoCol3"
        style="margin-right: 3px; min-width: fit-content;"
      >
        <li style="text-align: center; margin-bottom: -10px; min-width: fit-content;">
          <p
            id="ProjetosConcluidosAnoLabel3"
            style="min-width: fit-content;"
          />
        </li>
        <li
          id="ProjetosConcluidosAnoBarra3"
          class="ProjetosConcluidosHorizontalBar"
        >
          <!-- TOOLTIP da terceira barra -->
          <div
            id="ProjetosConcluidosAnoBarra3Tooltip"
            class="ProjetosConcluidosTooltipTextRight"
          >
            <div class="ProjetosConcluidosAnoFirstLine">
              <hr class="ProjetosConcluidosAnoFirstLineHR">
              <div
                id="ProjetosConcluidosAnoBarra3Total"
                class="ProjetosConcluidosAnoFirstLineMonthYear"
              >
                TOTAL DE
              </div>
            ...
            <div class="ProjetosConcluidosAnoSecondLine">
              <div
                id="ProjetosConcluidosAnoBarra3Qtd"
                class="ProjetosConcluidosAnoSecondLineQtd"
              />
              <div
                id="ProjetosConcluidosAnoBarra3Desc"
                class="ProjetosConcluidosAnoSecondLineDes"
                style="margin-top: -15px;"
              />
            </div>
      ...
      <ul
        id="ProjetosConcluidosAnoCol4"
        style="min-width: fit-content;"
      >
        <li style="text-align: center; margin-bottom: -10px; min-width: fit-content;">
          <p
            id="ProjetosConcluidosAnoLabel4"
            style="min-width: fit-content;"
          />
        </li>
        <li
          id="ProjetosConcluidosAnoBarra4"
          class="ProjetosConcluidosHorizontalBar"
        >
          <!-- TOOLTIP da quarta barra -->
          <div
            id="ProjetosConcluidosAnoBarra4Tooltip"
            class="ProjetosConcluidosTooltipTextRight"
          >
            <div class="ProjetosConcluidosAnoFirstLine">
              <hr class="ProjetosConcluidosAnoFirstLineHR">
              <div
                id="ProjetosConcluidosAnoBarra4Total"
                class="ProjetosConcluidosAnoFirstLineMonthYear"
              >
                TOTAL DE
              </div>
            ...
            <div class="ProjetosConcluidosAnoSecondLine">
              <div
                id="ProjetosConcluidosAnoBarra4Qtd"
                class="ProjetosConcluidosAnoSecondLineQtd"
              />
              <div
                id="ProjetosConcluidosAnoBarra4Desc"
                class="ProjetosConcluidosAnoSecondLineDes"
                style="margin-top: -15px;"
              />
            </div>
