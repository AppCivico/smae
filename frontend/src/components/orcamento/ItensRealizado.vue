...
const { totaisQueSuperamSOF, totaisDosItens } = storeToRefs(useOrcamentosStore());
    ...
    <div class="flex g2 mb2">
      ...
      <div class="f1">
        <div class="flex center flexwrap" v-if="respostasof.smae_soma_valor_empenho != undefined">
          ...
          <span class="t14">R$ {{ dinheiro(totaisDosItens.empenho) }}</span>
          <span v-if="totaisQueSuperamSOF.includes('empenho')" class="tvermelho w700 block">(valor supera empenho SOF)</span>
        </div>
      </div>
      ...
      <div class="f1">
        <div class="flex center flexwrap" v-if="respostasof.smae_soma_valor_liquidado != undefined">
          ...
          <span class="t14">R$ {{ dinheiro(totaisDosItens.liquidacao) }}</span>
          <span v-if="totaisQueSuperamSOF.includes('liquidacao')" class="tvermelho w700 block">(valor supera liquidação SOF)</span>
        </div>
      </div>
    </div>
</template>
