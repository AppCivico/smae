    ...
    <div id="submenu">
        <div class="subpadding">
            ...
            <template v-if="perm?.CadastroPainel">
                ...
                <div class="links-container mb2">
                    <router-link v-if="perm?.CadastroPainel" to="/paineis">Paineis de metas</router-link>
                    <router-link v-if="perm?.CadastroPainel" to="/paineis-grupos">Grupos de paineis</router-link>
                </div>
            </template>
        </div>
    </div>
