  ...
  children: [
    ...
    },
    {
      ...
      meta: {
        ...
        título: 'Cadastro de Painél de Obras',
      },
    },
    {
      path: ':painelId',
      ...
      children: [
        {
          ...
          meta: {
            ...
            título: () => usePlanosSetoriaisStore()?.emFoco?.nome || 'Editar Painel de Obras',
          },
        },
        {
          path: 'resumo',
          ...
          meta: {
            título: () => usePlanosSetoriaisStore()?.emFoco?.nome || 'Resumo de Painél de Obras',
