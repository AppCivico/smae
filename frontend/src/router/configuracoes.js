    ...
    children: [
          ...
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                name: 'mdo.gruposObservadores.editar',
                component: GruposDeObservadoresCriarEditar,
                props: ({ params }) => ({
                  ...params,
                  ...{
      ...
      },
      {
        ...
        meta: {
          ...
          entidadeMãe: 'mdo',
          rotaPrescindeDeChave: true,
          limitarÀsPermissões: ['ProjetoMDO.administrador'],
      ...
      },
      {
        ...
        component: () => import(
          '@/views/mdo.programasHabitacionais/ProgramaHabitacionalRaiz.vue'
        ),
        meta: {
...

      {
        ...
        children: [
          ...
          {
            path: ':grupoDeObservadoresId',
            name: 'projeto.gruposObservadores.editar',
            component: GruposDeObservadoresCriarEditar,
            props: ({ params }) => ({
              ...params,
              ...{
