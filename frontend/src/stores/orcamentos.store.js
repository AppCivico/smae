...
export const useOrcamentosStore = defineStore('Orcamentos', {
  ...
  actions: {
    ...
    async getOrcamentoCusteioById(
      id,
      ano,
      parametrosDeModulo = this.route.params,
    ) {
      try {
        this.OrcamentoCusteio[ano] = { loading: true };
        const r = await this.requestS.get(
          `${baseUrl}/${caminhoParaApi(parametrosDeModulo)}orcamento-previsto/?meta_id=${id}&ano_referencia=${ano}`,
        );
    ...
    async getOrcamentoPlanejadoById(
      idOrParams,
      ano,
      parametrosDeModulo = this.route.params,
    ) {
      ...
      try {
        ...
        const r = await this.requestS.get(
          `${baseUrl}/${caminhoParaApi(parametrosDeModulo)}orcamento-planejado/`,
          params,
        );
    ...
    async getOrcamentoRealizadoById(
      idOrParams,
      ano,
      parametrosDeModulo = this.route.params,
    ) {
      ...
      try {
        ...
        const r = await this.requestS.get(
          `${baseUrl}/${caminhoParaApi(parametrosDeModulo)}orcamento-realizado/`,
          params,
        );
    ...
    async buscarOrçamentosPrevistosParaAno(
      ...
      try {
        ...
        const r = await this.requestS.get(
          `${baseUrl}/${caminhoParaApi(parametrosDeModulo)}orcamento-previsto`,
          { ...extraParams, ano_referencia: ano },
        );
    ...
    // eslint-disable-next-line max-len, default-param-last
    async buscarOrçamentosPlanejadosParaAno(
      ano = this.route.params.ano,
      parametrosDeModulo = this.route.params,
      extraParams = {},
    ) {
    ...
    // eslint-disable-next-line max-len, default-param-last
    async buscarOrçamentosRealizadosParaAno(
      ano = this.route.params.ano,
      parametrosDeModulo = this.route.params,
      extraParams = {},
    ) {
    ...
    async restringirPrevistoAZero(
      ...
      if (this.route.params.meta_id && !parâmetrosCompletos.meta_id) {
        ...
        && !parâmetrosCompletos.projeto_id
      ) {
      ...
      try {
        if (
          await this.requestS.patch(
            `${baseUrl}/${caminhoParaApi(parametrosDeModulo)}orcamento-previsto/zerado/`,
            parâmetrosCompletos,
          )
        ) {
    ...
    async updateOrcamentoCusteio(
      ...
      if (
        await this.requestS.patch(
          `${baseUrl}/${caminhoParaApi(parametrosDeModulo)}orcamento-previsto/${id}`,
          params,
        )
      ) return true;
      return false;
    },
    async insertOrcamentoCusteio(
      params,
      parametrosDeModulo = this.route.params,
    ) {
      if (
    ...
    // Planejado
    async updateOrcamentoPlanejado(
      id,
      params,
      parametrosDeModulo = this.route.params,
    ) {
      if (
        await this.requestS.patch(
          `${baseUrl}/${caminhoParaApi(parametrosDeModulo)}orcamento-planejado/${id}`,
          params,
        )
      ) return true;
      return false;
    },
    async insertOrcamentoPlanejado(
      params,
      parametrosDeModulo = this.route.params,
    ) {
      if (
    ...
    // Realizado
    async updateOrcamentoRealizado(
      id,
      params,
      parametrosDeModulo = this.route.params,
    ) {
      if (
        await this.requestS.patch(
          `${baseUrl}/${caminhoParaApi(parametrosDeModulo)}orcamento-realizado/${id}`,
          params,
        )
      ) return true;
      return false;
    },
    async closeOrcamentoRealizado(
      params,
      parametrosDeModulo = this.route.params,
    ) {
      if (
        await this.requestS.patch(
          `${baseUrl}/${caminhoParaApi(parametrosDeModulo)}orcamento-realizado/orcamento-concluido`,
          params,
        )
      ) return true;
      return false;
    },
    async closeOrcamentoRealizadoPorOrgao(
      params,
      parametrosDeModulo = this.route.params,
    ) {
      return !!(await this.requestS.patch(
        `${baseUrl}/${caminhoParaApi(parametrosDeModulo)}orcamento-realizado/orcamento-concluido-admin`,
        params,
      ));
    },
    async insertOrcamentoRealizado(
      params,
      parametrosDeModulo = this.route.params,
    ) {
      if (
    ...
    async deleteOrcamentosRealizadosEmLote(
      ids,
      parametrosDeModulo = this.route.params,
    ) {
      if (
        await this.requestS.delete(
          `${baseUrl}/${caminhoParaApi(parametrosDeModulo)}orcamento-realizado/em-lote/`,
          ids,
        )
      ) return true;
      return false;
  ...
  getters: {
    ...
    líquidoDosItens() {
      ...
      return {
        ...
        liquidação:
          toFloat(smae_soma_valor_liquidado) - toFloat(soma_valor_liquidado),
      };
    },
    ...
    realizadoConsolidado: ({ OrcamentoRealizado }) => totalizador(OrcamentoRealizado, [
      'soma_valor_empenho',
