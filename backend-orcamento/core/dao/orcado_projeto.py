...
from .api_client import ClientDespesas as SofClient
from .base import Dao

from config import SOF_API_TOKEN

class OrcadoProjetoAtividade:
    ...
    def orcado_projeto(self, ano:int, mes:int, orgao:int, unidade: int,
                    proj_atividade: int, fonte: str)->list:

        data = self.sof(ano=ano, mes=mes, orgao=orgao,
